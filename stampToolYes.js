function StampTool1(){
	...
	this.icon = "assets/stamptool1.jpg";
	this.name = "Stamp Tool1";
    ...
    [{
       ...
       previousMouseX: -1,
       previousMouseX: -1,
       yesstamp: loadImage("assets/yesstamp.jpg"),
       height: 100,
       width:  100,
       heightobj: null,
       widthobj: null
    ...
    this.draw = function() 
    {
        ...
        { 
			...
			else
            {
                ...
                image(stampData[i].yesstamp, mouseX, mouseY,stampData[i].width,stampData[i].height)
			}
    ...
    //Increasing the size of a stamp in width or height.
    this.populateOptions = function()
    {
        ...
        for (let i = 0; i < stampData.length; i++)
        {
            ...
            {
                if(stampData[i].heightobj = select("#Stampheight3") && stampData[i].height <= 250)
                {
            ...
            stampData[i].heightobj.mousePressed(function()
            {
                if(stampData[i].heightobj = select("#Stampheight4") && stampData[i].height >= 200)
                {
                    stampData[i].height -= 50; 
                    console.log(stampData[i].width)
                }
